    ...
    <div className="w-full bg-white text-gray-800">
      ...
      <section className="bg-white text-gray-800 px-6 py-10 space-y-8 max-w-5xl mx-auto">
          ...
          <ul className="list-disc list-inside space-y-1">
            ...
            <li>
              ...
              <ul className="list-disc list-inside ml-5 mt-1">
                ...
                <li>
                  Graduate Cadre, Senior CO, Patrons, Patronesses: HND, BSc,
                  Postgraduate degrees or equivalent.
                </li>
              </ul>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul className="list-disc list-inside space-y-1">
            <li>
              Kindly find your way to the Cadet Armoury at Federal Science and
              Technical College, Yaba{" "}
            </li>
          </ul>
        </div>
