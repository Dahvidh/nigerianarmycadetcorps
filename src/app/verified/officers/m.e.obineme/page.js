...
const OfficerProfilePage = () => {
  return (
    <VerifiedOfficerProfile
      name="  Micheal Emmanuel Obineme"
      photo="/assets/obineme.jpg"
      rank="Cadet Lance Corporal"
      dob="04-06-2005"
      address="2 SUNNY MBILLA STREET. BUCKNOR, LAGOS NIGERIA"
      intake="2024"
      recruitmentDetails={{
        SerialNo: "NACC/OC/FSTCY/24/B/008",
        Batch: "2024 Bravo",
        Platoon: "Bravo Platoon",
        Department: "Anti Ripping Squad",
        Instructor: "CDT LT. Col. Jude Aneke",
        "Recruitment Date": "2024-10-31",
        "Medical Status": "Fit",
        Status: "Active",
        Post: "Nil",
