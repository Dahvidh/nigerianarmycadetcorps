...
const OfficerProfilePage = () => {
  return (
    <VerifiedOfficerProfile
      name="Cadet David O. Nnamdi"
      photo="/assets/passport.jpg"
      rank="Cadet 2nd Lieutenant"
      dob="04-06-2000"
      address="10, Ologun street by Awonusi junction, Ijegun, Lagos State, Nigeria"
      intake="2023"
      recruitmentDetails={{
        SerialNo: "NACC/OC/FSTCY/23/A/005",
        Batch: "2023 Bravo",
        Platoon: "Platoon 1",
        Unit: "Cadet Tactical squad, Cadet Provost unit",
        Instructor: "RTD. CDT MAJ Daniel Chima",
        "Recruitment Date": "2023-08-15",
        "Medical Status": "Fit",
        Status: "Active",
        Post: "Company Adjutant",
