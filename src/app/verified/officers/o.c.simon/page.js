...
const OfficerProfilePage = () => {
  return (
    <VerifiedOfficerProfile
      name="Cadet Ogbonna  C. Simon"
      photo="/assets/chinedu-1.jpg"
      rank="Cadet Staff Sargeant"
      dob="31-01-2004"
      address="14, Wasiu Alimi street Egan, Igando, Lagos State, Nigeria"
      intake="2022"
      recruitmentDetails={{
        SerialNo: "NACC/OC/FSTCY/22/A/007",
        Batch: "2022 Alpha",
        Platoon: "Platoon 1",
        Unit: "Cadet Special Forces, Anti Reaping Squad",  
        Instructor: "CDT LT. COL. J.O Aneke",
        "Recruitment Date": "2022-08-15",
        "Medical Status": "Fit",
        Status: "Active",
        Post: "Section Commanding Officer",
        "Training Status": "Partially active",
      }}
      medicalDetails={{
        BloodGroup: "O+",
        Genotype: "AS",
